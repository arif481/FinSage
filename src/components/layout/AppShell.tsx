...
const CategoriesIcon = () => (
  ...
  >
    <path d="M3 6h18" />
    <path d="M4 6l1.2 13a2 2 0 0 0 2 1.8h9.6a2 2 0 0 0 2-1.8L20 6" />
...
const navGroups = [
  {
    ...
    items: [
      ...
      { to: '/categories', label: 'Categories', short: 'CT', icon: <CategoriesIcon /> },
    ],
  },
  {
    label: 'Plan',
  ...
  {
    label: 'Collaborate',
    items: [{ to: '/spaces', label: 'Spaces', short: 'SP', icon: <SpacesIcon /> }],
  },
  {
    label: 'Insights',
    items: [
  ...
  {
    label: 'System',
    items: [{ to: '/settings', label: 'Settings', short: 'ST', icon: <SettingsIcon /> }],
  },
]
  ...
  return (
    <div className="app-shell">
            ...
            <div key={group.label} className="app-shell__nav-group">
              ...
              {group.items.map((item, itemIndex) => (
                <NavLink
                  ...
                  style={{
                    animation: `fade-up 400ms ease both ${150 + (groupIndex * 3 + itemIndex) * 55}ms`,
                  }}
                >
      ...
      <div
        ...
        style={{ animation: 'fade-up 400ms cubic-bezier(0.16, 1, 0.3, 1)' }}
      >
        <Outlet />
      </div>

      <div className="app-shell__mobile-quick">
        <QuickAddMenu variant="mobile" />
      </div>
