    ...
    <main className="screen stack">
              ...
              >
                  ...
                  <div>
                    ...
                    {goal.targetDate && (
                      <small style={{ color: 'var(--text-muted)' }}>
                        Target: {new Date(goal.targetDate).toLocaleDateString()} • Projected:{' '}
                        {getProjectedDate(goal)}
                      </small>
                    )}
                    {!goal.targetDate && (
                      <small style={{ color: 'var(--text-muted)' }}>
                        Projected completion: {getProjectedDate(goal)}
                      </small>
                    )}
                  </div>
                  <span
                    style={{
                      fontWeight: 700,
                      fontSize: '1.1rem',
                      color: pct >= 100 ? 'var(--success)' : 'var(--text)',
                    }}
                  >
                    {pct}%
                  </span>
                ...
                {isContributing && (
                  ...
                  >
                    ...
                    <button
                      className="primary-button"
                      type="button"
                      disabled={saving || !contributionAmount}
                ...
                <div className="button-row" style={{ marginTop: '0.75rem' }}>
                  ...
                  <button
                    ...
                    type="button"
                    style={{ fontSize: '0.85rem' }}
                    onClick={() => void handleStatusChange(goal.id, 'paused')}
                  >
                    ⏸ Pause
                  </button>
                  <button
            ...
            >
              ...
              <div className="button-row" style={{ marginTop: '0.5rem' }}>
                <button
                  ...
                  type="button"
                  style={{ fontSize: '0.85rem' }}
                  onClick={() => void handleStatusChange(goal.id, 'active')}
                >
                  ▶ Resume
                </button>
                <button
      ...
      {savingsGoals.length === 0 && !showForm && (
        <section className="card" style={{ textAlign: 'center', padding: '3rem 1rem' }}>
          ...
          <p className="section-subtitle">
            Create your first goal to start tracking your progress toward financial milestones.
          </p>
          <button
            className="primary-button"
            type="button"
