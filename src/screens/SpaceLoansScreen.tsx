...
export const SpaceLoansScreen = () => {
  ...
  useQuickCreateParam(
    ...
    { enabled: Boolean(space && user), scrollToId: 'space-loan-form' },
  )
      ...
      >
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
          <div>
            ...
            <small style={{ color: 'var(--text-muted)' }}>
              ...
              {loan.isEmi &&
                loan.emiAmount &&
                ` • ${formatCurrency(loan.emiAmount, currency)}/mo on day ${loan.emiDay}`}
            </small>
          </div>
        ...
        <div className="button-row" style={{ marginTop: '0.75rem' }}>
          {!isRepaying && (
            <button
              ...
              onClick={() => {
                ...
                setRepayAmount(loan.isEmi && loan.emiAmount ? String(loan.emiAmount) : '')
              }}
            >
              💰 Repay
            </button>
          ...
          <button
            ...
            type="button"
            style={{ fontSize: '0.85rem' }}
            onClick={() => void handleSettle(loan.id)}
          >
            ✅ Settle
          </button>
          <button
    ...
    <main className="screen stack">
      ...
      <header className="screen-header" style={{ animation: 'fade-up 400ms ease both' }}>
        <div>
          ...
          <p className="section-subtitle">
            Track who owes whom, manage EMIs and credit card installments.
          </p>
        </div>
        <button
          className="primary-button"
      ...
      <section className="insight-strip">
        {insightData.map((item, i) => (
          ...
          >
            ...
            <strong
              style={{
                color: item.label === 'Overdue' && overdueCount > 0 ? 'var(--danger)' : undefined,
              }}
            >
              {item.value}
            </strong>
        ...
        >
          ...
          >
            ...
            <div
              ...
              style={{ padding: '0.5rem', background: 'var(--bg-strong)', borderRadius: '0.8rem' }}
            >
              <input
                type="checkbox"
                checked={isEmi}
                ...
                id="emi-toggle"
              />
              <label htmlFor="emi-toggle" style={{ fontWeight: 700 }}>
                📅 This is an EMI / Installment loan
              </label>
            </div>
              ...
              >
                ...
                <div className="field-row">
                  ...
                  <label className="field">
                    ...
                    <input
                      type="text"
                      placeholder="e.g. HDFC Visa ending 4521"
                      value={creditCardLabel}
                      onChange={(e) => setCreditCardLabel(e.target.value)}
                    />
                  </label>
                </div>
              </div>
            ...
            <label className="field">
              ...
              <input
                type="text"
                placeholder="e.g. phone, electronics"
                value={loanTags}
                onChange={(e) => setLoanTags(e.target.value)}
              />
            </label>
        ...
        <section className="stack" style={{ gap: '0.75rem' }}>
          ...
          {settledLoans.map((loan) => (
            <article
              key={loan.id}
              className="card"
              style={{ borderLeft: '4px solid var(--success)', opacity: 0.7 }}
            >
              <div
              ...
              >
                <div>
                  ...
                  <small style={{ color: 'var(--text-muted)' }}>
                    {loan.description || 'Settled loan'} • {formatCurrency(loan.amount, currency)}
                  </small>
                </div>
                <button
                  className="secondary-button"
      ...
      {loans.length === 0 && !showForm && (
        <section className="card" style={{ textAlign: 'center', padding: '3rem 1rem' }}>
          ...
          <h3>No loans yet</h3>
          <p className="section-subtitle">
            Track money lent between members, credit card usage, and EMI installments.
          </p>
          <button
            className="primary-button"
            type="button"
