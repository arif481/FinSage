  ...
  return (
    <main className="screen stack">
        ...
        {insightData.map((item, i) => (
          ...
          >
            ...
            <strong
              style={{
                color:
                  item.label === 'Overdue' && overdueLoans.length > 0
                    ? 'var(--danger)'
                    : item.label === 'Net position' && totalLent - totalBorrowed > 0
                      ? 'var(--success)'
                      : item.label === 'Net position' && totalLent - totalBorrowed < 0
                        ? 'var(--danger)'
                        : undefined,
      ...
      {overdueLoans.length > 0 && (
        <section
          className="card"
          style={{ borderLeft: '4px solid var(--danger)', animation: 'fade-up 400ms ease both' }}
        >
      ...
      {showForm && (
        <section
          ...
          style={{ '--stagger': 1, animation: 'fade-up 400ms ease both' } as React.CSSProperties}
        >
      ...
      {activeLoans.length > 0 && (
        <section className="stack" style={{ gap: '0.75rem' }}>
          ...
          {activeLoans.map((loan, i) => {
            ...
            const pctPaid =
              loan.amount > 0 ? Math.round((loan.repaidAmount / loan.amount) * 100) : 0
                    ...
                    >
                      ...
                      <span
                        style={{
                          ...
                          color: loan.direction === 'lent' ? 'var(--success)' : 'var(--primary)',
                        }}
                      >
                ...
                {isRepaying && (
                  ...
                  >
                    ...
                    <button
                      ...
                      onClick={() => void handleRepay(loan.id, loan.repaidAmount)}
                    >
                      Record
                    </button>
                    <button
            ...
            >
              ...
              >
                <div>
                  ...
                  <small style={{ color: 'var(--text-muted)' }}>
                    {loan.description || loan.direction} • {formatCurrency(loan.amount, currency)}
                  </small>
                </div>
                <button
                  className="secondary-button"
